        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 lg:gap-12">
            ...
            <div className="space-y-6">
              <a href="mailto:itsmehdi.co.0707547044@gmail.com" className='hover:text-white transition-colors flex items-center gap-3'>
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-full bg-gradient-to-r from-[#111111] to-[#1A1A1A] flex items-center justify-center border border-[#222222]">
          ...
          <div className="rounded-[24px] bg-gradient-to-br from-[#111111] to-[#080808] p-6 md:p-8 border-2 border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg">
            ...
            <form className="space-y-6">
              ...
              <button 
                type="submit" 
                className="w-full px-8 py-4 bg-gradient-to-r from-[#111111] to-[#1A1A1A] rounded-xl flex items-center justify-center gap-3 hover:from-[#1A1A1A] hover:to-[#222222] transition-all text-lg border border-[#222222] hover:border-[#333333] shadow-md group"
              >
                Send Message
