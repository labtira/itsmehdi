    ...
    <div className=" bg-black text-white">
      <div className="max-w-full md:max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-16 xl:py-20">
        ...
        <div className="flex flex-col md:flex-row gap-6  mb-6 ">
          {/* Services Card */}
          <div className="rounded-[24px] bg-gradient-to-br from-[#111111] to-[#000000] p-4 flex flex-row items-center gap-3  border-2 border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg flex-grow">
            ...
            <div className="flex flex-col gap-2">
              <span className="px-4 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg text-xs  border border-[#222222] hover:border-[#333333] transition-colors shadow-md">Software Engineering</span>
              <span className="px-4 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg text-xs  border border-[#222222] hover:border-[#333333] transition-colors shadow-md">Graphic Design</span>
            </div>
          </div>

          {/* Social Links Card */}
          <div className="rounded-[24px] bg-gradient-to-br from-[#111111] to-[#000000] p-4 border-2 border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg">
        ...
        {/* Web Dev Section */}
        <div className="rounded-[24px] bg-gradient-to-br from-[#111111] to-[#000000] p-5 grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 lg:mb-12 border-2 border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg">
          <div className="flex flex-col justify-center">
            ...
            <Link 
              to="/contact"
              className="w-full sm:w-auto px-8 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg flex items-center justify-center gap-3 hover:from-[#1A1A1A] hover:to-[#000000] transition-all text-base lg:text-lg border border-[#222222] hover:border-[#333333] shadow-md group focus:outline-none"
            >
              Get In Touch
        ...
        <div className="mb-16 lg:mb-24">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 mb-12">
            {featuredProjects.map((project) => (
              <div key={project.id} className="rounded-[24px] overflow-hidden bg-gradient-to-br from-[#111111] to-[#000000] border-2 border-[#1A1A1A] hover:border-[#222222] transition-all duration-300 shadow-lg group">
                ...
                <div className="p-5">
                  ...
                  <Link 
                    ...
                    className="p-4 bg-gradient-to-r from-[#111111] to-[#000000] rounded-xl hover:from-[#1A1A1A] hover:to-[#000000] transition-all border border-[#222222] hover:border-[#333333] shadow-md group inline-flex focus:outline-none"
                  >
          ...
          <div className="flex justify-center">
            <Link 
              to="/projects"
              onClick={() => window.scrollTo({ top: 0, behavior: 'smooth' })}
              className="px-6 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg flex items-center gap-3 hover:from-[#1A1A1A] hover:to-[#000000] transition-all text-md border border-[#222222] hover:border-[#333333] shadow-md group focus:outline-none"
            >
              More
              <svg className="w-5 h-5 lg:w-6 lg:h-6 transform group-hover:translate-x-1 transition-transform" viewBox="0 0 24 24" fill="none">
                <path d="M5 12H19M19 12L12 5M19 12L12 19" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
