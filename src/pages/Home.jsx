          ...
          <div className="max-w-full md:max-w-screen-md mx-auto  py-8">
            ...
            <div className="flex flex-col md:flex-row gap-6  mb-6 ">
              ...
              <div className="rounded-[16px] bg-gradient-to-br from-[#111111] to-[#000000] p-4 flex flex-row items-center gap-3  border border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg flex-grow">
                ...
                <div className="flex flex-col gap-2">
                  <span className="px-4 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg text-xs  border border-[#222222] hover:border-[#333333] transition-colors shadow-md">Software Engineer</span>
                  <span className="px-4 py-2 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg text-xs  border border-[#222222] hover:border-[#333333] transition-colors shadow-md">Graphic Designer</span>
                </div>
              </div>
            ...
            <div className="rounded-[16px] bg-gradient-to-br from-[#111111] to-[#000000] p-5 grid grid-cols-1 md:grid-cols-2 gap-8 mb-8 lg:mb-12 border border-[#1A1A1A] hover:border-[#222222] transition-colors shadow-lg">
              <div className="flex flex-col justify-center">
                ...
                <Link 
                  to="/contact"
                  className="w-full sm:w-auto px-8 py-3 bg-gradient-to-r from-[#111111] to-[#000000] rounded-lg flex items-center justify-center gap-3 hover:from-[#1A1A1A] hover:to-[#000000] transition-all text-lg border border-[#222222] hover:border-[#333333] shadow-md group focus:outline-none"
                >
                  Get In Touch
