      ...
      <div className="max-w-full md:max-w-screen-md mx-auto  grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* About Card */}
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/itsmehdi.co/" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-instagram text-xl"></i>
            </a>
            <a href="https://www.linkedin.com/in/mehdilabtira/" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-linkedin text-xl"></i>
            </a>
            <a href="https://x.com/01mehdi_" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center  transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-twitter text-xl"></i>
            </a>
            <a href="https://wa.me/212707547044" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center transition-all hover:scale-105 focus:outline-none">
