      ...
      <div className="max-w-full md:max-w-screen-md mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* About Card */}
          ...
          <div className="flex gap-4">
            ...
            <a href="https://github.com/labtira" className="w-12 h-12 rounded-full bg-gradient-to-r from-[#111111] to-[#1A1A1A] flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
