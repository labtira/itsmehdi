  ...
  return (
    <footer className="">
      <div className="max-w-full md:max-w-screen-md mx-auto  grid grid-cols-1 md:grid-cols-2 gap-6">
        {/* About Card */}
          <div className="rounded-[16px] transition-all duration-500 backdrop-blur-xl bg-gradient-to-b from-black/10 to-black/30  shadow-[0_-8px_32px_rgba(0,0,0,0.12)] p-6 border border-[#222222] ">
          ...
          <div className="flex gap-4">
            <a href="https://www.instagram.com/itsmehdi.co/" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-instagram text-xl"></i>
            </a>
            <a href="https://www.linkedin.com/in/mehdilabtira/" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-linkedin text-xl"></i>
            </a>
            <a href="https://x.com/01mehdi_" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
              <i className="fab fa-twitter text-xl"></i>
            </a>
            <a href="https://wa.me/212707547044" className="w-12 h-12 rounded-full bg-darkgrey/30 flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
        ...
        {/* Newsletter Card */}
        {/* <div className="rounded-[16px] bg-gradient-to-br from-[#111111] to-[#000000] p-6 border border-[#222222] transition-colors shadow-lg">
          ...
          <div className="flex gap-3">
            ...
            />
            <button className="w-12 h-12 rounded-full bg-gradient-to-r from-[#111111] to-[#1A1A1A] flex items-center justify-center border border-[#222222] hover:border-[#333333] transition-all hover:scale-105 focus:outline-none">
